...
#define _128_TAU0_CHANNEL0_DIVISOR              (128U)
/* 8-bit timer data register 01 (TDR01H) */
#define _48_TAU_TDR01H_VALUE                    (0x48U)
/* Clock divisor for TAU0 channel 1 */
#define _16384_TAU0_CHANNEL1_DIVISOR            (16384U)
/* 16-bit timer data register 02 (TDR02) */
#define _DBB9_TAU_TDR02_VALUE                   (0xDBB9U)
/* Clock divisor for TAU0 channel 2 */
#define _128_TAU0_CHANNEL2_DIVISOR              (128U)

/* 16-bit timer data register 00 (TDR00) */
#define _4E1F_TAU_TDR00_VALUE                   (0x4E1FU)
...
#define _C34F_TAU_TDR07_VALUE                   (0xC34FU)
/* Clock divisor for TAU0 channel 7 */
#define TAU0_CHANNEL7_DIVISOR                   (4U)
...
/* Macros for controlling the scrolling of data on the LCD panel */
#define ENABLE_SCROLL                   (uint8_t)4
#define CONTINUOUS_SCROLL               (uint8_t)2
#define FINITE_SCROLL                   (uint8_t)1

/* Define the number of scroll sentences */
#define SCROLL_LINES                    4u

/* Define the scrolling data buffer size */
#define SCROLL_BUFF_SIZE                30u

/* Defines the alarm symbol's flashing period */
#define ALARM_TIMEOUT_2MIN              480u
...
/* Declare a status flag used to indicate whether the NULL character was encountered */
extern uint8_t  g_enable_scroll;
/* Strings to be scrolled across the star-burst segments.*/
