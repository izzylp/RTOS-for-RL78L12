...
enum PSLevel2
{
    STOP_Mode, HALT_Mode, SNOOZE_Mode, RUN
};

/* Function prototype for selecting the desired low power mode */
MD_STATUS Select_Power_Mode (enum PSLevel2 level);

/* SFR protect function prototype */
void SFR_Guard (uint8_t protect_on);

/* RAM protect function prototype */
void RAM_Guard (uint8_t protect_on);
